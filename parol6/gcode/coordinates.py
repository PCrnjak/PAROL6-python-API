...
class WorkCoordinateSystem:
    ...
    def get_offset(self, coord_system: Optional[str] = None) -> Dict[str, float]:
        """
    ...
    def get_tool_offset(self, tool_number: Optional[int] = None) -> float:
        """
    ...
    def work_to_machine(self, work_pos: Dict[str, float], 
                       coord_system: Optional[str] = None,
                       apply_tool_offset: bool = True) -> Dict[str, float]:
        """
    ...
    def machine_to_work(self, machine_pos: Dict[str, float],
                       coord_system: Optional[str] = None,
                       apply_tool_offset: bool = True) -> Dict[str, float]:
        """
    ...
    def apply_incremental(self, current_pos: Dict[str, float],
                         incremental: Dict[str, float]) -> Dict[str, float]:
        """
    ...
    def reset_offset(self, coord_system: Optional[str] = None) -> None:
        """
    ...
    def set_current_as_zero(self, machine_pos: Dict[str, float],
                           coord_system: Optional[str] = None) -> None:
        """
